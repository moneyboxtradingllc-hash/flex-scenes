...
export function HomeDesktop(props: HomeActions) {
  ...
  return (
    <div className="home-v2-desktop">
      <HomeLeftNav navigate={props.navigate} />
      <main className="home-v2-center" aria-label="Home feed">
      ...
      <HomeRightRail data={props.data} character={props.character} navigate={props.navigate} openConversation={props.openConversation} select={props.select} />
    </div>
  );
}
