...
export interface MediaStore { writeMockVisual(id: string, title: string, accent: string, label: string): string; ensureFixture(name: string, title: string, accent: string, label: string): string; saveUpload(id: string, filename: string, content: Buffer): string; }
